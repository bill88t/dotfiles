...
llama() {
    (
        ...
        ./llama-server \
            -m ~/sdcard/LLM/MiniCPM5-2B-Q4_K_M.gguf \
            --alias "MiniCPM5" \
            --host 0.0.0.0 --port 8080 \
            --prio-batch 3 -t 8 -fit off -lv 4 -lm mmap -ngl all \
            -b 256 -c 8192 --top-k 64 --temp 1.0 --top-p 0.95 --min-p 0 --repeat-penalty 1 --presence-penalty 0.3 \
            --jinja -cms 128 -np 1 -fa on --no-warmup --cache-type_k q4_0 --cache-type_v q4_0 \
